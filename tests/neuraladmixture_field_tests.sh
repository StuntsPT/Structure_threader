...
${structure_threader_exec} run -i "${git_dir}/tests/data/BigTestData.bed" -o ~/results_nad -nad "${str_bin}" -K 4 --exec_mode train --supervised True --nad_seed 42 -t 1 --pop "${git_dir}/tests/data/popfile.txt"
