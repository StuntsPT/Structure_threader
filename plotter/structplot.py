...
def dataminer(indfile_name):
    ...
    # TODO: Add option to parse structure output nd turn in into faststructure, or even better parse it right away. Preferebly with automatic detection.
...
def plotter(Qvalues):
    ...
    # TODO: Add pop labels and split bars
    plt.show()
